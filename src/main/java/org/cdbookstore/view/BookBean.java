...
public class BookBean implements Serializable {
	...
	private Predicate[] getSearchPredicates(Root<Book> root) {
		...
		String numberOfPages = this.example.getNumberOfPages();
		if (numberOfPages != null && !"".equals(numberOfPages)) {
			predicatesList.add(builder.like(
					builder.lower(root.<String> get("numberOfPages")),
					'%' + numberOfPages.toLowerCase() + '%'));
		}
